...
export const mockProducts: Product[] = [
  ...
  },
  {
    ...
    name: 'Coffee Maker',
    price: 79.99,
    image: 'https://images.unsplash.com/photo-1545665225-b23b99e4d45e?w=300&h=300&fit=crop',
...
export const mockOrders: Order[] = [
  {
    ...
    items: [
      ...
      { productId: '3', productName: 'Coffee Maker', quantity: 1, price: 79.99 }
    ],
    total: 179.98,
    status: 'pending',
  ...
  },
  {
    ...
    items: [
      ...
      { productId: '5', productName: 'Bluetooth Speaker', quantity: 1, price: 59.99 }
    ],
    total: 119.97,
    status: 'rejected',
